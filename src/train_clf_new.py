...
import argparse
import os
from RSNA.model.darknet_new import Darknet
from RSNA.lib.dataloader_c3_new import yolov3_dataset, yolov3_config, yolov3_batchsample
...
parse.add_argument("--model_cfg_path", type=str, default='RSNA/config/yolov3_new.cfg', help="model config path")
...
parse.add_argument("--checkpoint_dir", type=str, default="RSNA/checkpoints_stage2_new", help="directory where model weights save")
parse.add_argument("--tensorboardX_log", type=str, default="RSNA/Tensorboardx_stage2_new", help="directory where model log save")
...
need you define!!
"""
detail_log = "9anchors_dp0.1_w1e-5_bce_partxywh_loss1"
